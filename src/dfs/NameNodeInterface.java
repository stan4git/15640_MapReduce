...
public interface NameNodeInterface extends Remote {
	...
	public ConcurrentHashMap<String, ConcurrentHashMap<Integer, HashSet<String>>> getFileDistributionTable() throws RemoteException;
//	public ConcurrentHashMap<String, ConcurrentHashMap<Integer, HashSet<String>>> getFileDistributionTable(String filename) throws RemoteException;
	...
	public void updateFileDistributionTable(ConcurrentHashMap<String, ConcurrentHashMap<Integer, HashSet<String>>> tableToBeUpdated) throws RemoteException;
